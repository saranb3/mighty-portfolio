...
export function Footer() {
  return (
    <footer id="contact" className="bg-ink text-paper px-8 lg:px-16 pt-32 pb-12 relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        ...
        <h2 className="font-sans text-6xl lg:text-[200px] font-medium -tracking-[0.045em] leading-[0.92] mb-12">
          Thank
          <br />
          you<span className="ital text-mustard">.</span>
        </h2>
        ...
        <div className="-mx-8 lg:-mx-16 py-8 border-y border-white/15 overflow-hidden whitespace-nowrap mb-12">
          <div className="marquee-track inline-flex gap-12 font-serif italic text-5xl lg:text-6xl -tracking-[0.025em] font-normal text-paper">
        ...
        <div className="flex flex-wrap gap-4 justify-between font-mono text-[11px] tracking-widest text-ink-mute uppercase">
          <span>© MMXXVI · MIGHTY SARANBORIRAK</span>
